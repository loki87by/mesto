...
let closePopup = container.querySelector('.popup__close');
let addButton = profile.querySelector('.profile__button_type_add');
let closeAdds = document.getElementById('closeAdds');
let cards = content.querySelector('.cards');
const card = cards.querySelector('.card');
const cardTemplate = document.getElementById('card');
let cardOpen = popupCard.querySelector('.popup__image');
let cardTitle = popupCard.querySelector('.popup__image-title');
let cardClose = popupCard.querySelector('.popup__image-close');
...
let placeInput = form.querySelector('.popup__text_type_place');
let linkInput = form.querySelector('.popup__text_type_link');
